...
Dim Light
: Limited illumination, like being outside under a full moon without any artificial light sources. Creatures can only see in shades of gray, and take -2 ongoing to ability checks that require sight.

Darkness
: No illumination, like being in a room with no windows, doors, or artificial light sources. When inside, or trying to target a creature inside, you're blinded.

Magical Darkness
: Darkness that is fueled by magic instead of just a lack of light. It cannot be illuminated through non-magical means and cannot be seen through except by creatures that specifically can pierce it.

With those levels of light come different ways creatures can see through those levels of light, sometimes not requiring light at all. All vision is described within a certain range, beyond that range they have no extra senses and normal vision for the current lighting conditions apply.

Darkvision
: Can see in _dim light_ as if it were _bright light_ and can see in regular _darkness_ as if it were _dim light_ within range.

Tremmorsense
: Can detect the exact location of creatures and objects in range that are physically touching a surface they are, but cannot make out details that require sight (like colors or exact objects). Does not take penalties to checks that require sight to locate a creature or object within range.

Blindsight
: Can detect the exact location of creatures and objects in range, but cannot make out details that require sight (like colors or exact objects). Does not take penalties to checks that require sight to locate a creature or object within range.

Truesight
: Can see in any lighting condition,including _magical darkness_, as if it were _bright light_, as well as see invisible creatures and objects, as well as see through illusions, within range.

### Hiding

Whether you want to spy on another creature, sneak past someone, or try and set an ambush, you're going to want to hide. Your GM will tell you whether it's appropriate to hide. If you successfully hide, you become invisible.

#### Obscured Areas

Lightly Obscured
: Areas that are tough to see through, like patchy fog, or dim light. Ability checks that rely on sight take -2 ongoing while trying to see something in the area.

Heavily Obscured
: Areas that are totally opaque, like darkness or dense fog. You are blinded while trying to see something in the area.
...
Combat happens in rounds, each taking approximately 6 seconds to happen. At the start of combat, make a cunning roll; this is your **initiative** and determines the order in which you act.
...
Invisible
: You, and everything you're wearing or carrying is hidden from sight—you have advantage on initiative rolls and attack rolls and you cannot be targeted by effects that rely on sight.
