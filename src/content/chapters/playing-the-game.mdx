...
PCs also gain proficiency with different kinds of weapons and foci. If you have proficiency with the weapon or focus you're attacking with, add your proficiency bonus to the attack roll or saving throw DC of your attack. Monsters also add their proficiency bonus to their attack rolls and saving throw DCs.

All PCs start with proficiency with simple weapons.

PCs may also gain proficiency with armor and shields, allowing them to be worm normally. While you can wear armor or wield a shield if you're not proficient with it, the AC they provide is halved, and roll ability checks with disadvantage while you do.
...
import BasicTechniques from "$components/mdx/BasicTechniques.astro";
